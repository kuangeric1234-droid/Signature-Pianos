...
function guideInternalEmail({ lead, isRepeat, requestCount, adminUrl, crmSaved, customerEmailed, cameFrom }) {
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;background:#FFFFFF;">
  <tr><td style="padding:32px 36px;">
    ...
    <p style="margin:20px 0 0;font-family:${TEXT};font-size:14px;line-height:21px;color:${INK_SOFT};">They're in the pipeline now. The sooner you call or text, the warmer they'll be.</p>
